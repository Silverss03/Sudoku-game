...
icon = pygame.image.load('D:\Code\Python\Projects\Sudoku_game\images\sudoku_icon.png')
pygame.display.set_icon(icon)

#background
background = pygame.image.load('D:\Code\Python\Projects\Sudoku_game\images\menu.png')

#player
player_img = pygame.image.load('D:\Code\Python\Projects\Sudoku_game\images\pencil_mouse.png')
